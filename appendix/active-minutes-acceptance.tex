...
\tabulinesep=1.5mm
 ...
 \tabulinesep=1.5mm
  \begin{longtabu} to \textwidth {|X|c|X|}
    ...
    \\ \hline
    The system shall allow the user to group the collected data in "Hourly" and "Weekly" representation
    & Implemented
    & This is implemented in the History screen of the application
    \\ \hline
    The user shall be able to set "Sleeping Hours", time interval during which no measurement of \gls{pa} or \gls{st} should occur
    & Implemented
    & 
    \\ \hline
 \end{longtabu}
