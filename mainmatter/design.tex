    ...
    \end{figure}
        ...
        \begin{enumerate}
            ...
            \begin{itemize}
                ...
                \item \textbf{Task conformance}. The system facilitates enough features to satisfy basic sedentary time self-management (see chapter \ref{Chapter:Specification}).
            \end{itemize}
        \end{enumerate}
