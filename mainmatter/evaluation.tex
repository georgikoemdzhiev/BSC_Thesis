...
In addition to the above-mentioned types of testing, usability testing has been performed on the system to determine if it is easy to use. This test was performed in a control environment i.e. one of the project participants 
assess more the software of the system, usability testing assess the \gls{ui} of the system i.e. if the system is easy to use. 
