...
A questionnaire was created containing a total of 9 questions. Consequently, valuable information was extracted from the survey participants such as if the system work i.e., apply behaviour change theory via self-management successfully. All questionnaire questions can be seen in Appendix \ref{chapter:survey-results}.
