...
\newglossaryentry{mci}{
    name=MCI,
    description = {Maximum Continuous Inactivity}
}

\newglossaryentry{shti}{
    name=SHTI,
    description = {Sleeping Hours Time Interval. The start and end time interval when a person normally goes to sleep and wakes up, accordingly}
}
